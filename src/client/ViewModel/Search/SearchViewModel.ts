...
class SearchViewModel extends ViewModel {
    ...
    */
    public getReserveStatus(programId: apid.ProgramId): 'reserve' | 'conflict' | 'skip' | null {
        let reserves = this.reservesApiModel.getAllId();
    ...
    */
    private createRuleOption(): apid.RuleOption {
        let option: apid.RuleOption = { enable: this.enable };
    ...
    */
    private createAddRule(): apid.AddRule {
        let addRule: apid.AddRule = {
            search: this.createRuleSearch(),
            option: this.createRuleOption(),
        }

        let encode = this.createRuleEncode();
