...
class RulesDB extends SQLite3Base implements RulesDBInterface {
    /**
    * create table
    * @return Promise<void>
    */
    ...
    */
    enable(id: number): Promise<void> {
        return this.runQuery(`update ${ DBSchema.TableName.Rules } set enable = 1 where id = ${ id }`);
    }
    ...
    */
    disable(id: number): Promise<void> {
        return this.runQuery(`update ${ DBSchema.TableName.Rules } set enable = 0 where id = ${ id }`);
    }
