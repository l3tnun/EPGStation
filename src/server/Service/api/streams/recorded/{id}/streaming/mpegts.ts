...
import RecordedStreamingMpegTsStream from '../../../../../../Model/Service/Stream/RecordedStreamingMpegTsStream';
...
export const get: Operation = async(req, res) => {
    ...
    try {
        ...
        if (err.message === RecordedStreamingMpegTsStream.OutOfRangeError) {
            api.responseError(res, { code: 416,  message: 'out of range' });
        } else if (err.message === RecordedStreamingMpegTsStream.FileIsNotFoundError) {
