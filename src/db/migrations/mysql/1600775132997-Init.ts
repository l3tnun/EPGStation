...
export class Init1600775132997 implements MigrationInterface {
    public name = 'Init1600775132997';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            'CREATE TABLE `channel` (`id` bigint NOT NULL, `serviceId` int NOT NULL, `networkId` int NOT NULL, `name` varchar(255) NOT NULL, `halfWidthName` varchar(255) NOT NULL, `remoteControlKeyId` int NULL, `hasLogoData` tinyint NOT NULL DEFAULT 0, `channelType` varchar(255) NOT NULL, `channel` varchar(255) NOT NULL, `type` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `drop_log_file` (`id` int NOT NULL AUTO_INCREMENT, `errorCnt` bigint NOT NULL, `dropCnt` bigint NOT NULL, `scramblingCnt` bigint NOT NULL, `filePath` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `program` (`id` bigint NOT NULL, `updateTime` bigint NOT NULL, `channelId` bigint NOT NULL, `eventId` bigint NOT NULL, `serviceId` int NOT NULL, `networkId` int NOT NULL, `startAt` bigint NOT NULL, `endAt` bigint NOT NULL, `startHour` int NOT NULL, `week` int NOT NULL, `duration` int NOT NULL, `isFree` tinyint NOT NULL, `name` varchar(255) NOT NULL, `halfWidthName` varchar(255) NOT NULL, `shortName` varchar(255) NOT NULL, `description` text NULL, `halfWidthDescription` text NULL, `extended` text NULL, `halfWidthExtended` text NULL, `genre1` int NULL, `subGenre1` int NULL, `genre2` int NULL, `subGenre2` int NULL, `genre3` int NULL, `subGenre3` int NULL, `channelType` varchar(255) NOT NULL, `channel` varchar(255) NOT NULL, `videoType` text NULL, `videoResolution` text NULL, `videoStreamContent` int NULL, `videoComponentType` int NULL, `audioSamplingRate` int NULL, `audioComponentType` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `recorded_tag` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `halfWidthName` varchar(255) NOT NULL, `color` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `thumbnail` (`id` int NOT NULL AUTO_INCREMENT, `filePath` varchar(255) NOT NULL, `recordedId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `video_file` (`id` int NOT NULL AUTO_INCREMENT, `parentDirectoryName` int NOT NULL, `filePath` varchar(255) NOT NULL, `type` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `size` bigint NOT NULL DEFAULT 0, `recordedId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `recorded` (`id` int NOT NULL AUTO_INCREMENT, `reserveId` int NULL, `ruleId` int NULL, `programId` bigint NULL, `channelId` bigint NOT NULL, `isProtected` tinyint NOT NULL DEFAULT 0, `startAt` bigint NOT NULL, `endAt` bigint NOT NULL, `duration` int NOT NULL, `name` varchar(255) NOT NULL, `halfWidthName` varchar(255) NOT NULL, `description` text NULL, `halfWidthDescription` text NULL, `extended` text NULL, `halfWidthExtended` text NULL, `genre1` int NULL, `subGenre1` int NULL, `genre2` int NULL, `subGenre2` int NULL, `genre3` int NULL, `subGenre3` int NULL, `videoType` text NULL, `videoResolution` text NULL, `videoStreamContent` int NULL, `videoComponentType` int NULL, `audioSamplingRate` int NULL, `audioComponentType` int NULL, `isRecording` tinyint NOT NULL, `dropLogFileId` int NULL, UNIQUE INDEX `REL_e0bc5373673ea0f120445830f4` (`dropLogFileId`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
            'CREATE TABLE `recorded_history` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `channelId` bigint NOT NULL, `endAt` bigint NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
