...
export class Init1596953150168 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE "drop_log_file" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "errorCnt" bigint NOT NULL, "dropCnt" bigint NOT NULL, "scramblingCnt" bigint NOT NULL, "filePath" varchar NOT NULL)',
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            'CREATE TABLE "video_file" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "parentDirectoryName" integer NOT NULL, "filePath" varchar NOT NULL, "type" varchar NOT NULL, "name" varchar NOT NULL, "size" bigint NOT NULL DEFAULT (0), "recordedId" integer NOT NULL)',
        );
        await queryRunner.query(
