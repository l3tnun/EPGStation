        ...
        <v-dialog v-if="isRemove === false" v-model="dialogState.isOpen" max-width="500" scrollable>
            <v-card v-if="dialogState.displayData !== null">
                <v-card-text class="pa-4">
                    ...
                    <div
                        v-if="typeof dialogState.displayData.extended !== 'undefined'"
                        class="extended my-2"
                        id="program-extended"
                    >
                ...
                <div class="pa-2 encode-action">
                    ...
                    <div>
                        <div class="d-flex justify-end">
                            ...
                            <v-btn
                                v-else-if="dialogState.reserve.type === 'skip'"
                                v-on:click="removeReserveSkip"
                                color="blue darken-1"
                                text
                            >
                                除外解除
                            ...
                            <v-btn
                                v-else-if="dialogState.reserve.type === 'overlap'"
                                v-on:click="removeReserveOverlap"
                                color="blue darken-1"
                                text
                            >
                                重複解除
