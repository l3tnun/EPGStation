<template>
    <div
        v-if="searchState.getSearchResult() !== null || searchState.isTimeSpecification === true"
        class="search-rule-option"
    >
        <v-card class="mx-auto" max-width="800">
                ...
                <v-expansion-panels :value.sync="searchState.optionPanel" accordion multiple flat class="option-panels">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                <div class="d-flex flex-wrap">
                                    <v-checkbox
                                        class="mx-1 my-0"
                                        v-model="searchState.reserveOption.enable"
                                        label="有効"
                                    ></v-checkbox>
                                    <v-checkbox
                                        class="mx-1 my-0"
                                        v-model="searchState.reserveOption.allowEndLack"
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                <v-text-field
                                    class="period"
                                    v-model="searchState.reserveOption.periodToAvoidDuplicate"
                                    min="0"
                                    label="日数"
                                    type="number"
                                    clearable
                                ...
                                <v-checkbox
                                    class="mx-1 my-0"
                                    v-model="searchState.reserveOption.avoidDuplicate"
                                    label="録画済み番組を排除"
                                ></v-checkbox>
                            </SearchOptionRow>
                        </v-expansion-panel-content>
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                ></v-select>
                                <v-text-field
                                    v-model="searchState.saveOption.directory"
                                    label="sub directory"
                                    clearable
                                ></v-text-field>
                            </SearchOptionRow>
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                <v-text-field
                                    v-model="searchState.saveOption.recordedFormat"
                                    label="file format"
                                    clearable
                                ></v-text-field>
                            </SearchOptionRow>
                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                ></v-select>
                                <v-text-field
                                    v-model="searchState.encodeOption.directory1"
                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                ></v-select>
                                <v-text-field
                                    v-model="searchState.encodeOption.directory2"
                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                ></v-select>
                                <v-text-field
                                    v-model="searchState.encodeOption.directory3"
            ...
            <v-card-actions>
                ...
                <v-btn v-if="this.searchState.isEditingRule() === true" v-on:click="onClickUpdate" text color="primary">
                    更新
                </v-btn>
