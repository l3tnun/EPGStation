...
@injectable()
export default class OnAirSelectStreamSettingStorageModel
    extends AbstractStorageBaseModel<IOnAirSelectStreamSettingValue>
    implements IOnAirSelectStreamSettingStorageModel {
